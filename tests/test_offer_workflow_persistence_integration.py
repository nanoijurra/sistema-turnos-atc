...
def test_persistir_request_creado_desde_oferta_se_recupera_desde_store() -> None:
    ...
    request = crear_request_formal_desde_oferta(
        ...
        selection_note="Seleccion persistida explicitamente",
    )
    ...
    assert recuperado.offer_origin["selection_note"] == "Seleccion persistida explicitamente"